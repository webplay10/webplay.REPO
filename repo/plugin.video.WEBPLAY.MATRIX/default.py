...
nome_contador = "plugin.video.WEBPLAY"
link_contador = "https://whos.amung.us/pingjs/"    


##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = "[B][COLOR white]||||||| ADDON plugin.video.WEBPLAY|||||||[/COLOR][/B]"
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = "DESCRIÇÃO ADDON plugin.video.WEBPLAY"
...
#### MENU VIP ################################################################
titulo_vip = "[B][COLOR white]plugin.video.WEBPLAY[/COLOR] - [COLOR gold](VIP)[/COLOR][/B]"
...
url_origem = 'https://raw.githubusercontent.com/webplay10/WEBPLAY/master/Entrada'
try:
...
def init_SKindex(msg):
   ...
   if status_mensagem1 == 'true':
    dialog = xbmcgui.Dialog()
    link = dialog.select("[B]BEM-VINDOS AO [COLOR white]plugin.video.WEBPLAY[/COLOR][/B]", [
    "[B][COLOR blue]plugin.video.WEBPLAY - [/COLOR] Facebook[/B]",
    "[B][COLOR pink]plugin.video.WEBPLAY - [/COLOR] Instagram[/B]",
    "[B][COLOR white]plugin.video.WEBPLAY - [/COLOR] WhatsApp [/B]",
    "[B][COLOR green]plugin.video.WEBPLAY - [/COLOR] ENTRAR NO ADD-ON [/B]"])    
      
    if link == 0:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
         xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://plugin.video.WEBPLAY' ) )
     else:
        ost = webbrowser . open ( 'https://plugin.video.WEBPLAY' )
    ...
    if link == 2:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
         ost = xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://plugin.video.WEBPLAY' ) )
     else:
        webbrowser . open ( 'https://plugin.video.WEBPLAY' ) 
