...
<p align="left">
  <ul>
    ...
    <li>Em Addons, instalar de um ficheiro zip. Quando perguntar pela localização, selecionar "webplay.REPO", e instalar <a href="webplay.REPO.zip,webpaly.REPO-MATRIX.zip">webplay.REPO.zip</a>.</li>
    -
